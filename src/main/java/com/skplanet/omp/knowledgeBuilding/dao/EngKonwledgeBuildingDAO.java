 ...
 * 
 */
public class EngKonwledgeBuildingDAO {

	private static SqlSessionFactory sqlmap = null;
	private String resource = "com/skplanet/omp/knowledgeBuilding/sql/mybatisConfDicEng.xml";
	 ...
	 * Constructor
	 */
	public EngKonwledgeBuildingDAO(){
	...
	public void insertAspectExpr(InsertAspectExprData aspectExprData) {
		...
		try{
			...
			if(exprExist == 0)
			{
				aspectExprData.setRepresentationId((String)session.selectOne("KnowledgeBuildingMapper.selectRepresentationId",aspectExprData.getRepresentationId()));				
	...
	/**
	 * name: insertAspectExpr
	 * description: 추출된 영문 속성-표현 저장하기
	 * @return
	 */
	@SuppressWarnings("unchecked")
	public void insertEngAspectExpr(InsertAspectExprData aspectExprData) {
		...
		try{
			...
			if(exprExist == 0)
			{
				aspectExprData.setRepresentationId("1");				
